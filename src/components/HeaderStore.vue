...
<template>
    ...
    <nav class="navbar navbar-expand-lg navbar-light" id="top_nav">
        <div class="container" style="height: 82px;">
            <a class="navbar-brand" href="/" style="margin-right:150px;margin-top:-5px;">
                <img src="https://www.netabooks.vn/Data/Sites/1/skins/default/img/logo-netabooks.svg" class="img-fluid" alt="..." width="260" height="200">
            </a>

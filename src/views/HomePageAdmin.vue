...
<template>
    <div class="container" id="main_content_pageAdmin">
        <div class="content_admin_page">
            <h1>Quản Lí WebSite Netabooks Store</h1>
            ...
            <ul class="nav nav-pills mb-3 mt-4 cọntainer-fluid" id="pills-tab" role="tablist" style="border:1px solid #ccc;width:fit-content;border-radius:10px;">
                <li class="nav-item" role="presentation" id="quanlisach">
                    <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true"><i class="fa-solid fa-book"></i> Quản Lý Sách </button>
                </li>
                <li class="nav-item" role="presentation" id="quanlidanhmuc">
                    <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false"><i class="fa-solid fa-tag"></i> Quản Lý Danh Mục</button>
                </li>
                <li class="nav-item" role="presentation" id="quanlitacgia">
                    <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false"><i class="fa-solid fa-book-open-reader"></i> Quản Lý Tác Giả</button>
                </li>
                <li class="nav-item" role="presentation" id="quanlitheloai">
                    <button class="nav-link" id="pills-test-2" data-bs-toggle="pill" data-bs-target="#pills-test" type="button" role="tab" aria-controls="pills-test" aria-selected="false"><i class="fa-regular fa-font-awesome"></i> Quản Lý Thể Loại</button>
                </li>
                ...
                <li class="nav-item" role="presentation" id="quanlidonhang">
                    <button class="nav-link" id="pills-chinh-2" data-bs-toggle="pill" data-bs-target="#pills-chinh" type="button" role="tab" aria-controls="pills-chinh" aria-selected="false"><i class="fa-solid fa-boxes-stacked"></i> &nbsp;Quản Lý Đơn Hàng</button>
                </li>

            ...
            <div class="col-lg-5">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb" style="align-items: center;">
                        ...
                        <li class=" breadcrumb-item active" aria-current="page" style="color:blue;font-weight:bold">Xác nhận thành công đơn hàng</li>
                    </ol>
                </nav>


                <p>Mã đơn hàng: <span style="color:black;font-weight:bold">{{ dataCompleteOrder._id }}</span> </p>
                <p style="color: red;">Cảm ơn bạn đã mua hàng !</p>

            ...
            <div class="col-lg-7">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb" style="align-items: center;">
                        ...
                        <li class="breadcrumb-item active" aria-current="page" style="color:blue;font-weight:bold
                                    ">Thông tin giao hàng </li>
                        <li class="breadcrumb-item active" aria-current="page" style="color:black">Xác nhận thành công đơn hàng</li>
                    </ol>
                </nav>
